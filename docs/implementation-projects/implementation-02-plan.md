...
- [docs/implementation-projects/archive/2026-04-product-improvement-complete/02-resume-provenance-and-gap-drillthrough.md](archive/2026-04-product-improvement-complete/02-resume-provenance-and-gap-drillthrough.md) describes the prior goal as making the preview auditable without forcing users to inspect JSON, while explicitly keeping raw JSON as an advanced surface.
